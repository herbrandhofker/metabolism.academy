...
import academy.kafka.AppConfig;
...
public class KafkaUtils {
    ...
    public static <T> int produceEntities(String topic, Class<?> clazz, Function<String, T> fromJson, int seconds) {
        ...
        props = ProducerConfig.addSerializerToConfig(props, new StringSerializer(), new JsonSerializer<T>());
        ...
        while (it.isValid()) {
            ...
            producer.send(new ProducerRecord<String, T>(topic, key, entity), new Callback() {
                ...
                public void onCompletion(RecordMetadata metadata, Exception e) {
                    if (e != null) {
                        System.out.println("Wrting to Kafka failed with an exception {}" + e.getMessage());
    ...
    public static <T> void consumeEntities(String topic, Class<?> clazz, String grpName) {
        ...
        props = ConsumerConfig.addDeserializerToConfig(props, new StringDeserializer(), new JsonDeserializer<T>());
